...
MAP_ITEMS = {
    ...
    DUNGEON_PREFIX_LABEL + '3': {TRIFORCE_LABEL: True},
    DUNGEON_PREFIX_LABEL + '4': {HEARTRECEPTACLE_LABEL: True},
    DUNGEON_PREFIX_LABEL + '6': {BOOMERANG_LABEL: True},
    DUNGEON_PREFIX_LABEL + '11': {KEY_LABEL: True}
}
