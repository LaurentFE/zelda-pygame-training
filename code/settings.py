...
PLAYER_INITIAL_HEALTH = 7 * PLAYER_HEALTH_PER_HEART
PLAYER_INITIAL_MONEY = 0
PLAYER_INITIAL_KEY = 2
PLAYER_INITIAL_BOMB = 4
PLAYER_INITIAL_HAS_BOMB = True
PLAYER_INITIAL_HAS_BOOMERANG = True
PLAYER_INITIAL_HAS_RED_CANDLE = True
PLAYER_INITIAL_HAS_LADDER = True
PLAYER_INITIAL_HAS_WOOD_SWORD = True
PLAYER_INITIAL_ITEM_A = WOOD_SWORD_LABEL
PLAYER_INITIAL_ITEM_B = BOOMERANG_LABEL
PLAYER_BOMBS_MAX = 12
...
DARKNUT_SHIELD_LEFT_FRAME_ID = 366
DARKNUT_SHIELD_UP_FRAME_ID = 368
DARKNUT_SHIELD_DOWN_FRAME_ID = 370
DARKNUT_SHIELD_RIGHT_FRAME_ID = 372
...
NEW_DUNGEON_BOTTOM_CENTER_POS = (SCREEN_WIDTH / 2 - TILE_SIZE, SCREEN_HEIGHT - TILE_SIZE * 6 - 1)
UNDERWORLD_STAIRS = [
...
STARTING_MAP = DUNGEON_STARTING_MAP
STARTING_SCREEN = '1'
