...
class TextBlock(pygame.sprite.Sprite):
    def __init__(self, groups: list, text, font_tile_set, pos_y, pos_x=None):
        super().__init__(groups)
        self.text = text.lower()
        self.font_tile_set = font_tile_set
    ...
    def draw_message(self):
        ...
        for i in range(nb_row):
            for j in range(len(formatted_text[i])):
                ...
                char_image = self.font_tile_set.get_sprite_image(char_id)
